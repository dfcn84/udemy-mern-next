...
const CardPost = ({ post, user, setPosts, setShowToastr }) => {
    ...
    const isLiked = likes.length > 0 && likes.filter(like => like.user === user._id) > 0;
        ...
        <>
            <Segment basic>
                <Card color="teal" fluid>
                    ...
                    <Card.Content>
                        <Image floated="left" src={ post.user.profilePhotoUrl } avatar circular />
                        ...
                        <Card.Description style={{ fontSize:"17px", letterSpacing:"0.1px", wordsSpacing:"0.35px"}}>
                            { post.text }
                        </Card.Description>
                    </Card.Content>
                    <Card.Content extra>
